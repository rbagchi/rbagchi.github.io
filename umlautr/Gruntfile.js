...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/TestApp.st', // list all sources in dependency order
                    'src/TestApp-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-testapp',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'TestApp', /* add other code-to-test packages here */
                    'SUnit',
                    'TestApp-Tests' /* add other test packages here */
                ],
